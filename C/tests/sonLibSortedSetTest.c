...
static int64_t size = 9;
static int64_t input[] = { 1, 5, -1, 10, 3, 12, 3, -10, -10 };
...
static void test_stSortedSetIterator_getIteratorFrom(CuTest* testCase) {
    ...
    for(i=0; i<sortedSize; i++) {
        stSortedSetIterator *it = stSortedSet_getIteratorFrom(sortedSet, stIntTuple_construct1( sortedInput[i]));
    ...
    stTry {
        stSortedSet_getIteratorFrom(sortedSet, stIntTuple_construct1( 7)); //This number if not in the input.
...
static void test_stSortedSetDifference(CuTest* testCase) {
    ...
    CuAssertTrue(testCase, !stSortedSet_equals(sortedSet, sortedSet3));
    stSortedSet_insert(sortedSet3, stIntTuple_construct1( 1));
    stSortedSet_insert(sortedSet3, stIntTuple_construct1( 5));
    CuAssertTrue(testCase, stSortedSet_equals(sortedSet, sortedSet3));
    stSortedSet_destruct(sortedSet3);
...
static void test_stSortedSet_searchLessThanOrEqual(CuTest* testCase) {
    ...
    CuAssertTrue(testCase, stSortedSet_searchLessThanOrEqual(sortedSet,
            stIntTuple_construct1( (int64_t)-11)) == NULL);
    CuAssertTrue(testCase, stSortedSet_searchLessThanOrEqual(sortedSet,
                stIntTuple_construct1( (int64_t)-10)) == stSortedSet_search(sortedSet, stIntTuple_construct1( (int64_t)-10)));
    CuAssertTrue(testCase, stSortedSet_searchLessThanOrEqual(sortedSet,
                 stIntTuple_construct1( (int64_t)-5)) == stSortedSet_search(sortedSet, stIntTuple_construct1( (int64_t)-10)));
    CuAssertTrue(testCase, stSortedSet_searchLessThanOrEqual(sortedSet,
                 stIntTuple_construct1( (int64_t)1)) == stSortedSet_search(sortedSet, stIntTuple_construct1( (int64_t)1)));
    CuAssertTrue(testCase, stSortedSet_searchLessThanOrEqual(sortedSet,
                 stIntTuple_construct1( (int64_t)13)) == stSortedSet_search(sortedSet, stIntTuple_construct1( (int64_t)12)));
    CuAssertTrue(testCase, stSortedSet_searchLessThanOrEqual(sortedSet,
                 stIntTuple_construct1( (int64_t)7)) == stSortedSet_search(sortedSet, stIntTuple_construct1( (int64_t)5)));

    for(int64_t i=0; i<100; i++) {
        stSortedSet_insert(sortedSet, stIntTuple_construct1( st_randomInt(-1000, 1000)));
    }
    ...
    for(int64_t i=1; i<stList_length(list); i++) {
        ...
        stIntTuple *k = stIntTuple_construct1( st_randomInt(stIntTuple_getPosition(p, 0), stIntTuple_getPosition(j, 0)));
...
static void test_stSortedSet_searchLessThan(CuTest* testCase) {
    ...
    CuAssertTrue(testCase, stSortedSet_searchLessThan(sortedSet,
            stIntTuple_construct1( -11)) == NULL);
    CuAssertTrue(testCase, stSortedSet_searchLessThan(sortedSet,
            stIntTuple_construct1( -10)) == NULL);
    CuAssertTrue(testCase, stSortedSet_searchLessThan(sortedSet,
            stIntTuple_construct1( -5)) == stSortedSet_search(sortedSet, stIntTuple_construct1( -10)));
    CuAssertTrue(testCase, stSortedSet_searchLessThan(sortedSet,
            stIntTuple_construct1( 13)) == stSortedSet_search(sortedSet, stIntTuple_construct1( 12)));
    CuAssertTrue(testCase, stSortedSet_searchLessThan(sortedSet,
            stIntTuple_construct1( 8)) == stSortedSet_search(sortedSet, stIntTuple_construct1( 5)));
    CuAssertTrue(testCase, stSortedSet_searchLessThan(sortedSet,
                stIntTuple_construct1( 1)) == stSortedSet_search(sortedSet, stIntTuple_construct1( -1)));
    CuAssertTrue(testCase, stSortedSet_searchLessThan(sortedSet,
            stIntTuple_construct1( 10)) == stSortedSet_search(sortedSet, stIntTuple_construct1( 5)));
    ...
    for(int64_t i=1; i<stList_length(list); i++) {
        stIntTuple *p = stList_get(list, i-1);
        stIntTuple *j = stList_get(list, i);
        stIntTuple *k = stIntTuple_construct1( st_randomInt(stIntTuple_getPosition(p, 0)+1, stIntTuple_getPosition(j, 0)+1));
...
static void test_stSortedSet_searchGreaterThanOrEqual(CuTest* testCase) {
    ...
    CuAssertTrue(testCase, stSortedSet_searchGreaterThanOrEqual(sortedSet,
            stIntTuple_construct1( -11)) == stSortedSet_search(sortedSet, stIntTuple_construct1( -10)));
    CuAssertTrue(testCase, stSortedSet_searchGreaterThanOrEqual(sortedSet,
            stIntTuple_construct1( -10)) == stSortedSet_search(sortedSet, stIntTuple_construct1( -10)));
    CuAssertTrue(testCase, stSortedSet_searchGreaterThanOrEqual(sortedSet,
            stIntTuple_construct1( -5)) == stSortedSet_search(sortedSet, stIntTuple_construct1( -1)));
    CuAssertTrue(testCase, stSortedSet_searchGreaterThanOrEqual(sortedSet,
            stIntTuple_construct1( 1)) == stSortedSet_search(sortedSet, stIntTuple_construct1( 1)));
    CuAssertTrue(testCase, stSortedSet_searchGreaterThanOrEqual(sortedSet,
            stIntTuple_construct1( 13)) == NULL);
    CuAssertTrue(testCase, stSortedSet_searchGreaterThanOrEqual(sortedSet,
            stIntTuple_construct1( 5)) == stSortedSet_search(sortedSet, stIntTuple_construct1( 5)));
...
static void test_stSortedSet_searchGreaterThan(CuTest* testCase) {
    ...
    CuAssertTrue(testCase, stSortedSet_searchGreaterThan(sortedSet,
            stIntTuple_construct1( -11)) == stSortedSet_search(sortedSet, stIntTuple_constructN(1, (int64_t []){ -10 })));
    CuAssertTrue(testCase, stSortedSet_searchGreaterThan(sortedSet,
            stIntTuple_construct1( -10)) == stSortedSet_search(sortedSet, stIntTuple_construct1( -1)));
    CuAssertTrue(testCase, stSortedSet_searchGreaterThan(sortedSet,
            stIntTuple_construct1( -5)) == stSortedSet_search(sortedSet, stIntTuple_construct1( -1)));
    CuAssertTrue(testCase, stSortedSet_searchGreaterThan(sortedSet,
            stIntTuple_construct1( 1)) == stSortedSet_search(sortedSet, stIntTuple_construct1( 3)));
    CuAssertTrue(testCase, stSortedSet_searchGreaterThan(sortedSet,
            stIntTuple_construct1( 13)) == NULL);
    CuAssertTrue(testCase, stSortedSet_searchGreaterThan(sortedSet,
            stIntTuple_construct1( 12)) == NULL);
